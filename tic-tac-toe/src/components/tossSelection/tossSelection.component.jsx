	...
	return (
		<div>
			<div className='toss-selection'>
				<Typography variant='h3' component='div' sx={{ textAlign: 'center', margin: '4%' }}>There will be a toss to decide the first move.</Typography>
			...
			<div className='choice-section'>
				<Button variant='contained' color='primary' onClick={() => handleClick(event, setFirstPlayerChoice)}>Heads</Button>
				<Button variant='contained' color='success' onClick={() => handleClick(event, setFirstPlayerChoice)}>Tails</Button>
			</div>
		</div>
	);
};